...
import sty from "./PlasmicProduct.module.css"; // plasmic-import: owuqEWnNvgl-/css
    ...
    >
      {renderPlasmicSlot({
        defaultContents: (
          <PlasmicImg__
            alt={""}
            className={classNames(sty.img__juK4X)}
            displayHeight={"auto"}
            ...
            loading={"lazy"}
            src={{
              src: "/plasmic/fit_poosh/images/neckties2103471920Jpg.jpg",
              fullWidth: 1920,
              fullHeight: 1280,
