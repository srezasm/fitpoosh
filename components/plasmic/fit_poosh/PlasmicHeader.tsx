...
function PlasmicHeader__RenderFunc(props: {
  ...
  return (
    ...
    >
      ...
      >
        <div className={classNames(projectcss.all, sty.column__ocxgf)}>
          <Stack__
            as={"div"}
            hasGap={true}
            className={classNames(projectcss.all, sty.freeBox__q9Pwb)}
          >
            <Stack__
              as={PlasmicLink__}
              hasGap={true}
            ...
            >
              {false ? (
                <IconIcon
                  className={classNames(projectcss.all, sty.svg___4Mj24)}
                  role={"img"}
                />
              ) : null}
              <div
              ...
              {false ? (
                <IconIcon
                  className={classNames(projectcss.all, sty.svg__xig8H)}
                  role={"img"}
                />
              ) : null}
            </Stack__>
            ...
            >
              {false ? (
                <IconIcon
                  className={classNames(projectcss.all, sty.svg___9MOhe)}
                  role={"img"}
                />
              ) : null}
              <div
              ...
              {false ? (
                <IconIcon
                  className={classNames(projectcss.all, sty.svg__avCGx)}
                  role={"img"}
                />
              ) : null}
            </Stack__>
        ...
        <div className={classNames(projectcss.all, sty.column__uUjsz)}>
          <PlasmicLink__
            className={classNames(
              projectcss.all,
              projectcss.a,
        ...
        <div className={classNames(projectcss.all, sty.column___3XBde)}>
          <div className={classNames(projectcss.all, sty.freeBox__vsJky)}>
            <PlasmicLink__
              className={classNames(
                projectcss.all,
                projectcss.a,
